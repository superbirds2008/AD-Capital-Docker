...
java ${APP_AGENT_JAVA_OPTS} ${JMX_OPTS} -jar ${CLIENT_HOME}/QueueReader.jar &

#echo APP_AGENT_JAVA_OPTS: ${APP_AGENT_JAVA_OPTS};
#java -javaagent:${CATALINA_HOME}/appagent/javaagent.jar ${APP_AGENT_JAVA_OPTS} ${APP_AGENT_JAVA_OPTS} ${JMX_OPTS} -jar ${CLIENT_HOME}/QueueReader.jar &
